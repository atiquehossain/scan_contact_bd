...
5. Scanner messages appear in the app under private chats/requests.
6. Reply from the owner app without exposing your phone number.
7. Keep phone visibility off unless direct public contact is intended.
8. Use the account area for privacy and support actions.
